...
function openExportDialog(titleText,subtitleText,showTextAsImageOption){
  ...
  var imageView = [[NSImageView alloc] initWithFrame: NSMakeRect(316, 62, 143, 39)];
  var file = sketchApp.resourceNamed(isDarkMode ? "logo_white.png" : "logo.png");
...
function isDarkModeEnabled(){
  return (MSApplicationMetadata.metadata().appVersion >= 52) ? [[NSUserDefaults standardUserDefaults] stringForKey:@"AppleInterfaceStyle"]=="Dark" : false;
}
