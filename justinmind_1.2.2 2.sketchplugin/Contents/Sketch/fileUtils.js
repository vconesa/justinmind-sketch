...
function unzipJIMFile(folderURL){
  ...
  var arguments = NSArray.arrayWithObject(resolve('../Resources/base.vp'));
...
function zipJIMFile(folderURL,jimFile){
  ...
  //var arguments = NSArray.arrayWithObjects("-r",jimFile,"./"); //fail Mac High Sierra
  var arguments = new Array(3);
  arguments[0] = "-r";
  arguments[1] = jimFile;
  arguments[2] = "./";
